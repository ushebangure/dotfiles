...
Plug 'kristijanhusak/vim-hybrid-material' "<--- ACTIVE
...
" -------------------------------------------------------------------------------------------------
colorscheme hybrid_material "Available options: [one, onehalflight, PaperColor, gruvbox, hybrid, nord, hybrid_material, dracula]
